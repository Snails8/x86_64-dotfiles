let indentStartTokens,indentEndTokens,indentElseTokens,indentStartOrElseTokens,tokenForIndentStartOrElseTokens,hasStartAndEndToken,phpKeywordStartTokens,phpKeywordEndTokens,indentStartAndEndTokens,inlineFunctionTokens,optionalStartWithoutEndTokens,util,vsctm;_486‍.x([["default",()=>Formatter]]);_486‍.w("./indent",[["indentStartTokens",["indentStartTokens"],function(v){indentStartTokens=v}],["indentEndTokens",["indentEndTokens"],function(v){indentEndTokens=v}],["indentElseTokens",["indentElseTokens"],function(v){indentElseTokens=v}],["indentStartOrElseTokens",["indentStartOrElseTokens"],function(v){indentStartOrElseTokens=v}],["tokenForIndentStartOrElseTokens",["tokenForIndentStartOrElseTokens"],function(v){tokenForIndentStartOrElseTokens=v}],["hasStartAndEndToken",["hasStartAndEndToken"],function(v){hasStartAndEndToken=v}],["phpKeywordStartTokens",["phpKeywordStartTokens"],function(v){phpKeywordStartTokens=v}],["phpKeywordEndTokens",["phpKeywordEndTokens"],function(v){phpKeywordEndTokens=v}],["indentStartAndEndTokens",["indentStartAndEndTokens"],function(v){indentStartAndEndTokens=v}],["inlineFunctionTokens",["inlineFunctionTokens"],function(v){inlineFunctionTokens=v}],["optionalStartWithoutEndTokens",["optionalStartWithoutEndTokens"],function(v){optionalStartWithoutEndTokens=v}]]);_486‍.w("./util",[["*",null,function(v){util=v}]]);_486‍.w("./vsctm",[["*",null,function(v){vsctm=v}]]);/* eslint-disable class-methods-use-this */
