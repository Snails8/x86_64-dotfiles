_bc9‍.x([["optional",()=>optional],["readFile",()=>readFile],["splitByLines",()=>splitByLines],["formatStringAsPhp",()=>formatStringAsPhp],["formatRawStringAsPhp",()=>formatRawStringAsPhp],["getArgumentsCount",()=>getArgumentsCount],["normalizeIndentLevel",()=>normalizeIndentLevel],["printDiffs",()=>printDiffs],["generateDiff",()=>generateDiff],["prettifyPhpContentWithUnescapedTags",()=>prettifyPhpContentWithUnescapedTags],["prettifyPhpContentWithEscapedTags",()=>prettifyPhpContentWithEscapedTags],["removeSemicolon",()=>removeSemicolon],["formatAsPhp",()=>formatAsPhp],["preserveOriginalPhpTagInHtml",()=>preserveOriginalPhpTagInHtml],["revertOriginalPhpTagInHtml",()=>revertOriginalPhpTagInHtml],["indent",()=>indent],["unindent",()=>unindent],["preserveDirectives",()=>preserveDirectives],["preserveDirectivesInTag",()=>preserveDirectivesInTag],["revertDirectives",()=>revertDirectives],["revertDirectivesInTag",()=>revertDirectivesInTag],["printDescription",()=>printDescription],["checkResult",()=>checkResult],["debugLog",()=>debugLog]]);/* eslint-disable max-len */
...
const {
  ...
  return prettier.format(content.replace(/\n$/, ''), {
    ...
    phpVersion: '8.0',
       ...
       function formatRawStringAsPhp(content) {
  return prettier
